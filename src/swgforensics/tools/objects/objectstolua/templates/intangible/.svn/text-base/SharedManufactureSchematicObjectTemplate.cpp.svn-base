...
SharedManufactureSchematicObjectTemplate::SharedManufactureSchematicObjectTemplate(IffStream* str) :
...
void SharedManufactureSchematicObjectTemplate::parseFileData(IffStream* iffStream) {
...
void SharedManufactureSchematicObjectTemplate::parseVariableData(const QString& varName, Chunk* data) {
}

void SharedManufactureSchematicObjectTemplate::toLua(QTextStream& buffer) {
	//writeLuaHeader(buffer);

	buffer << endl;

	buffer << luaObjectName << " = SharedManufactureSchematicObjectTemplate:new {" << endl;
